package com.atguigu.p2pinvestjinrong.util;
...
import com.atguigu.p2pinvestjinrong.common.MyApplication;
...
public class UIUtils {
    ...
    public static String[] getStringArr(int strAArrId) {
        String[] stringArray = getContext().getResources().getStringArray(strAArrId);
        return stringArray;
    }
